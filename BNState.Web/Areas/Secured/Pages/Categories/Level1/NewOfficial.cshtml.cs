...
namespace BNState.Web.Areas.Secured.Pages.Categories.Level1
{
    ...
    public class NewOfficialModel : PageModel
    {
        ...
        public NewOfficialModel(BNState.Domain.Data.ApplicationDbContext context, UserManager<Profile> userManager, IConfiguration config, IStorageService storageService)
        {
            _context = context;
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            else
            {
                ...
                var result = await _userManager.CreateAsync(user, "Benue@2023");
                if (result.Succeeded)
                {
