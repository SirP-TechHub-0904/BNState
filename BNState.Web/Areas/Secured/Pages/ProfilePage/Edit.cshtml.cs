...
namespace BNState.Web.Areas.Secured.Pages.ProfilePage
{
    ...
    public class EditModel : PageModel
    {
        ...
        public EditModel(BNState.Domain.Data.ApplicationDbContext context, UserManager<Profile> userManager, IConfiguration config, IStorageService storageService)
        {
            _context = context;
        ...
        public async Task<IActionResult> OnGetAsync(string id, string p1, string p2, long? lid)
        {
            ...
            var levels = await _context.Category2s.FindAsync(id);
            if (levels == null)
            {
                return NotFound();
            }
